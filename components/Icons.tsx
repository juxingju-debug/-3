...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12 3L9.5 8.5L4 11L9.5 13.5L12 19L14.5 13.5L20 11L14.5 8.5L12 3Z" stroke="currentColor" fill="currentColor" strokeOpacity="0.3" fillOpacity="0.3" />
        <path d="M5 3L6 5" />
        <path d="M19 3L18 5" />
        <path d="M5 21L6 19" />
        <path d="M19 21L18 19" />
...
export const EraserIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M19.06 2.94a2.82 2.82 0 0 1 4 4L8 22l-6-6 17.06-17.06Z"/>
        <line x1="22" x2="12.4" y1="8" y2="17.6"/>
    </svg>
);

export const MagicWandIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="m21.64 3.64-1.28-1.28a1.21 1.21 0 0 0-1.72 0L2 18.16V22h3.84L21.64 5.36a1.21 1.21 0 0 0 0-1.72Z"/>
        <path d="m14 7 3 3"/>
        <path d="M5 3v4"/>
        <path d="M3 5h4"/>
        <path d="M19 17v4"/>
...
export const BackgroundIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="m14.5 12.5 2-2a2 2 0 0 1 2.828 0L21 12.172" />
    </svg>
);
...
export const ShapesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M8.3 10a.7.7 0 0 1-.626-1.079l1.497-3.818a.7.7 0 0 1 1.211 0l1.497 3.818A.7.7 0 0 1 11.3 10Z" />
        <path d="M14.207 13.363a.7.7 0 0 1 1.079.626v3.132a.7.7 0 0 1-1.211.492l-2.353-2.353a.7.7 0 0 1 .03-1.06l2.455-2.455Z" />
        <path d="M3.7 18a.7.7 0 0 1-.492-1.211l3.132-3.132a.7.7 0 0 1 1.06.03l2.455 2.455a.7.7 0 0 1-.626 1.079H3.7Z" />
        <path d="M18 21h-5" />
        <path d="M21 15v6" />
        <path d="M21 3v6" />
        <path d="M15 3h6" />
...
export const PuzzleIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M4 7h3a1 1 0 0 0 1 -1v-1a2 2 0 0 1 4 0v1a1 1 0 0 0 1 1h3a2 2 0 0 1 2 2v3a1 1 0 0 0 1 1h1a2 2 0 0 1 0 4h-1a1 1 0 0 0 -1 1v3a2 2 0 0 1 -2 2h-3a1 1 0 0 0 -1 1v1a2 2 0 0 1 -4 0v-1a1 1 0 0 0 -1 -1h-3a2 2 0 0 1 -2 -2v-3a1 1 0 0 0 -1 -1h-1a2 2 0 0 1 0 -4h1a1 1 0 0 0 1 -1v-3a2 2 0 0 1 2 -2z" />
    </svg>
);
...
export const FitToScreenIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const Grid3x3Icon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
